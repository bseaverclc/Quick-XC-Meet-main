...
//                }
                ...
                if(AppData.userID == "UeneL2Wo2WWNRufYo95UC3hqae42") // || self.canEditSchools
                {
...
//                    }
            ...
            let edit = UITableViewRowAction(style: .normal, title: "Edit") { (action, indexPath) in
                if(AppData.userID != "UeneL2Wo2WWNRufYo95UC3hqae42")
                {
                    let denyAlert = UIAlertController(title: "Error", message: "Contact developer at bseaver38@gmail.com to edit school name or delete school", preferredStyle: .alert)
                    denyAlert.addAction(UIAlertAction(title: "OK", style: .default, handler: nil))
                    self.present(denyAlert, animated: true, completion: nil)
                }
                else{
...
//               })
               ...
               alert.addAction(UIAlertAction(title: "Add", style: .default, handler: { (updateAction) in
                ...
                for school in AppData.schoolsNew{
                    ...
                    else if school.inits == initSchool{
...
//                   }
                ...
                if !badInput{
//******* put this back when reading url******************
//                       if csvURL != ""{
